...
The browser runs headless Chrome. The random port prevents conflicts with a developer's local server, and the isolated H2 database ensures the test does not depend on or modify existing application data.
